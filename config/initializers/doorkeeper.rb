...
Doorkeeper.configure do
  ...
  #
  access_token_expires_in (Rails.env.development? ? 1.year : 24.hours)
  # dev token http://localhost:3000/api/v1/profiles/me?access_token=Y91dWYQqn322-1NiIxjvXSxfz1pZwZ78kupDTJdQoTM
